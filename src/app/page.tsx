...
>
  ...
  {/* CONTEÚDO */}
  <div className="relative z-10 max-w-[1100px] mx-auto px-[18px] grid grid-cols-2  md:grid-cols-1 gap-6">

    <div className="animated-on-scroll">
      <h2 className="m-0 mb-2 text-[1.4rem]">Experiência construída em campo</h2>
      <p className="mt-0 mb-3.5 text-gray-300">
    ...
    <div className="flex flex-row gap-3 justify-between animated-on-scroll delay-md">

      <div className="py-3 px-3.5 text-green-600 bg-white rounded-full h-[150px] w-[150px] text-center bg-gradient-to-br from-[rgba(199,160,82,0.1)] to-[rgba(199,160,82,0.02)] border border-[rgba(199,160,82,0.28)]">
        <BiTrophy className="mx-auto mb-2 text-4xl"/>
        <span className="block text-3xl font-semibold">7</span>
        <span className="text-sm">Victórias</span>
      </div>

      <div className="py-3 px-3.5 text-green-600 bg-white rounded-full h-[150px] w-[150px] text-center bg-gradient-to-br from-[rgba(199,160,82,0.1)] to-[rgba(199,160,82,0.02)] border border-[rgba(199,160,82,0.28)]">
        <FaBriefcase className="mx-auto mb-2 text-4xl"/>
        <span className="block text-3xl font-semibold">50+</span>
        <span className="text-sm">Campeonatos</span>
      </div>

      <div className="py-3 px-3.5 text-green-600 bg-white rounded-full h-[150px] w-[150px] text-center bg-gradient-to-br from-[rgba(199,160,82,0.1)] to-[rgba(199,160,82,0.02)] border border-[rgba(199,160,82,0.28)]">
        <FaUsers className="mx-auto mb-2 text-4xl"/>
        <span className="block text-3xl font-semibold">158</span>
        <span className="text-sm">Total de Membros</span>
      </div>

      <div className="py-3 px-3.5 text-green-600 bg-white rounded-full h-[150px] w-[150px] text-center bg-gradient-to-br from-[rgba(199,160,82,0.1)] to-[rgba(199,160,82,0.02)] border border-[rgba(199,160,82,0.28)]">
        <FaBuilding className="mx-auto mb-2 text-4xl"/>
        <span className="block text-3xl font-semibold">9</span>
